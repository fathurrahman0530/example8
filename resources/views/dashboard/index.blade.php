...
<div class="card card-chat overflow-hidden">
    <div class="card-body d-flex p-0 h-100">
        <div class="chat-sidebar">
            <div
                class="contacts-list scrollbar-overlay os-host os-theme-dark os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
                    ...
                    <div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid"
                        ...
                        <div class="os-content" style="padding: 0px; height: 100%; width: 100%;">
                            <div class="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                                <div class="hover-actions-trigger chat-contact nav-item active" role="tab"
                                    id="chat-link-0" data-bs-toggle="tab" data-bs-target="#chat-0"
                                    aria-controls="chat-0" aria-selected="true">
                                    <div class="d-md-none d-lg-block">
                                        <div class="dropdown dropdown-active-trigger dropdown-chat">
                                            <button
                                                ...
                                                <svg class="svg-inline--fa fa-cog fa-w-16"
                                                    data-fa-transform="shrink-3 down-4" aria-hidden="true"
                                                    focusable="false" data-prefix="fas" data-icon="cog" role="img"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                    data-fa-i2svg="" style="transform-origin: 0.5em 0.75em;">
                                                    <g transform="translate(256 256)">
                                                        <g
                                                            transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)">
                            ...
                            <div class="px-3 pt-2">
                                <div class="nav flex-column font-sans-serif fw-medium">
                                  <a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="#!">
                                    <span class="conversation-info-icon"><svg
                                                class="svg-inline--fa fa-search fa-w-16 me-1"
                                                data-fa-transform="shrink-1 down-3" aria-hidden="true" focusable="false"
                                                data-prefix="fas" data-icon="search" role="img"
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                data-fa-i2svg="" style="transform-origin: 0.5em 0.6875em;">
                                                <g transform="translate(256 256)">
                                                    <g
                                            ...
                                            <!-- <span class="fas fa-search me-1" data-fa-transform="shrink-1 down-3"></span> Font Awesome fontawesome.com --></span
                                            >Search
                                        in Conversation</a><a
                                        class="nav-link d-flex align-items-center py-1 px-0 text-600" href="#!"><span
                                            class="conversation-info-icon"><svg
                                            ...
                                            <!-- <span class="fas fa-pencil-alt me-1" data-fa-transform="shrink-1"></span> Font Awesome fontawesome.com --></span>Edit
                                        Nicknames</a><a class="nav-link d-flex align-items-center py-1 px-0 text-600"
                                        href="#!"><span class="conversation-info-icon"><svg
                                            ...
                                            <!-- <span class="fas fa-palette me-1" data-fa-transform="shrink-1"></span> Font Awesome fontawesome.com --></span><span>Change
                                            Color</span></a><a
                                        class="nav-link d-flex align-items-center py-1 px-0 text-600" href="#!"><span
                                            class="conversation-info-icon"><svg
                                            ...
                                            <!-- <span class="fas fa-thumbs-up me-1" data-fa-transform="shrink-1"></span> Font Awesome fontawesome.com --></span>Change
                                        Emoji</a><a class="nav-link d-flex align-items-center py-1 px-0 text-600"
                                        href="#!"><span class="conversation-info-icon"><svg
                                                class="svg-inline--fa fa-bell fa-w-14 me-1" data-fa-transform="shrink-1"
                                            ...
                                            <!-- <span class="fas fa-bell me-1" data-fa-transform="shrink-1"></span> Font Awesome fontawesome.com --></span>Notifications</a>
                                </div>
                            </div>
                            <hr class="my-2">
                            ...
                            <div class="px-3 pt-2">
                                <div class="nav flex-column font-sans-serif fw-medium"><a
                                        class="nav-link d-flex align-items-center py-1 px-0 text-600" href="#!"><span
                                            ...
                                            <!-- <span class="fas fa-search me-1" data-fa-transform="shrink-1 down-3"></span> Font Awesome fontawesome.com --></span>Search
                                        in Conversation</a><a
                                        class="nav-link d-flex align-items-center py-1 px-0 text-600" href="#!"><span
                                            class="conversation-info-icon"><svg
                                                class="svg-inline--fa fa-pencil-alt fa-w-16 me-1"
